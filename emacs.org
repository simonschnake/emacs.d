...
This my emacs-config. It is ~not~ stable at the moment
...
- very good python ide
- advanced org-mode
  - ob-ipython
  - tools to write a tuftle styled latex in org-mode
  - bibliography managment
  - good support fort editing org src parts without =C-'=
- ipython jupyter notebook handling
